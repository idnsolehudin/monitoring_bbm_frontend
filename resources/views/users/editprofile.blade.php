                        ...
                        <div class="product-image">
                            <div class="col-md-8 col-sm-8">
                                <div class="position relative" style="position: relative;">
                                    <img 
                                    id="previewFoto"
                                    src="{{ $user['images'] ? 'https://monitoringbbm.com/files/'.$user['images'] : '../public/images/user-icon.png'}}"
                            ...
                            <div class="col-md-4 col-sm-4 " style="border:0px solid #e5e5e5;"> 
                                    ...
                                    <div class="position-relative p-0 mb-2">
                                        ...
                                        <div class="pt-4 pb-0 mb-0">
                                            <input class="form-control"  type="password" style="border: none; border-bottom: 2px solid #333; outlineL none; background:transparent; padding:2px; font-size: 24px;" name="password"/>                                      
                                        </div>
                                    </div>                                                  
                                     <div class="position-relative p-0 mb-2">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" style="-moz-appearance: textfield; border: none; border-bottom: 2px solid #333; outlineL none; background:transparent; padding:2px; font-size: 24px;" name="phone" required="required" placeholder="8xxxxx" value="{{ substr($user['phone'], 3) }}"/>
                                        </div>
                                    </div>                                              
                                    <div class="position-relative p-0 mb-2">
