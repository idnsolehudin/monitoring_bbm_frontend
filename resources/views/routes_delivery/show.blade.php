                          ...
                          @foreach ($routes as $data)  
                            <tr>
                              ...
                              <td class="text-center">
                                <a href="{{ route('edit.route', $data['id']) }}" title="Edit"><i class="fa-solid fa-pen-to-square" style="color: #c79d03;"></i></a>
                                <form class="d-inline" action="{{ route('delete.route', $data['id']) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
