					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{ route('store.vehicletype') }}" method="POST" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="kode-rute" required="required" class="form-control" name="merk" placeholder="Merk Kendaraan">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="cc" class="form-control" type="number" name="cc" placeholder="CC/Silinder">
											</div>
										</div>
										<div class="item form-group">
											<label for="ratio" class="col-form-label col-md-3 col-sm-3 label-align">Ratio</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="ratio" class="form-control" type="number" name="ratio" placeholder="Rasio">
											</div>
										</div>
