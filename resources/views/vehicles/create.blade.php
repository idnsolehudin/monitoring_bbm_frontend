                            ...
                            <div class="col-md-4 col-sm-4 " style="border:0px solid #e5e5e5;"> 
                                    ...
                                    <div class="position-relative p-0 mb-2">
                                        ...
                                        <div class="pt-4 pb-0 mb-0">
                                            <input class="form-control" style="border: none; border-bottom: 2px solid #333; outline: none; background:transparent; padding:2px; font-size: 24px;" name="code" required="required" placeholder="Kode Kendaraan"/>                                      
                                        </div>
                                    </div>                        
                                    <div class="position-relative p-0 mb-2">
                                        <div class="d-inline position-absolute top-0 start-0 translate-middle"> Nomor Polisi : </div>
                                        <div class="pt-4 pb-0 mb-0">
                                            <input class="form-control" style="border: none; border-bottom: 2px solid #333; outline: none; background:transparent; padding:2px; font-size: 24px;" name="nopol" required="required" placeholder="Nomor Polisi"/>                                      
                                        </div>
                                    </div>                                               
                                    <div class="position-relative p-0 mb-2">
                                        <div class="d-inline position-absolute top-0 start-0 translate-middle"> Kilometer Awal : </div>
                                        <div class="pt-4 pb-0 mb-0">
                                            <input  type="number" class="form-control" style="border: none; border-bottom: 2px solid #333; outline: none; background:transparent; padding:2px; font-size: 24px;" name="first_km" required="required" placeholder="KM Awal"/>                                      
                                        </div>
                                    </div>                                               
                                    <div class="position-relative p-0 mb-2">
